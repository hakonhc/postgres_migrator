...
fn test_list_sql_files() -> io::Result<()> {
	...
	fs::File::create("migrations/agh/40_yoyo.sql")?;
	fs::create_dir("migrations/agh/doh")?;
	fs::File::create("migrations/agh/doh/50_yoyo.sql")?;
	...
	assert_eq!(migration_files, vec![
		...
		PathBuf::from("migrations/agh/40_yoyo.sql"),
		PathBuf::from("migrations/agh/doh/50_yoyo.sql"),
	]);
